...
export class CreatepaymentComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        //var hash = CryptoJS.HmacSHA1("6.9"+"764764000000074"+"poom"+"00000000010000091205"+"1"+"764"+"000000000100"+"kitipoom.se@gmail.com"+"6"+"Y", "h0V3gkT45xSg"); //correct!!!
         //this.texx = hash;

    }
    insertval(){
        this.versionno = "6.9";
        this.merchantid ="764764000000074";
        ...
        this.userdefined4 = "";
        this.userdefined5 = "";
        //this.resulturl1 = "http://61.91.121.190/2c2pfrontend/uat/demomerchant/v3uifrontendurl.aspx";
        this.resulturl1 = "http://localhost:4931/Default";
        //this.resulturl1 = "http://27.254.138.123:50001/e-commerce/api/proxy/completePaymentOrder";
        //this.resulturl2 = "http://27.254.138.123:50001/e-commerce/api/public/proxy/receivePaymentOrder";
        //this.resulturl2= "http://27.254.138.120"
        this.resulturl2 = "http://27.254.138.123:50001/e-commerce/api/public/proxy/receivePaymentPOSOrder"
        this.request3ds ="Y";
